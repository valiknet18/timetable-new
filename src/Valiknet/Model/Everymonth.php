...
class Everymonth extends Event implements InterfaceObject
{
    ...
    public function create()
    {
        ...
        try {
            ...
            $sql = "INSERT INTO everymonth(repeatedat, everymonth, event_code) VALUES(?, ?, ?)";

            $insertInEveryday = $this->getPdo()->prepare($sql);
            $insertInEveryday->execute(array($this->repeatedat, $this->everymonth, $lastIndex));
    ...
    public function setData(Request $request)
    {
        ...
        $this->repeatedat = $request->request->get('repeated_at');
        $this->everymonth = $request->request->get('everymonth');
